...
export interface StepsS3CopyConstructProps {
  ...
  /**
   * A sourceBucket in the installation account that will be used for working
   * artifacts such as temporary files, distributed maps outputs etc.
   * These objects will be small, but the sourceBucket can be set with a
   ...
   * in the target sourceBucket account. This can be set as it might be possible that the
