  ...
  implements IChainable, INextable
{
  ...
  grantNestedPermissions(stateMachine: StateMachine) {
    ...
    this.props.iterator.policyStatements.forEach((s) =>
  ...
  protected makeNext(_next: State) {
    throw new Error("makeNext shouldn't be used here");
    //super.makeNext(next);
  ...
  override toStateJson(): object {
    const stateJson = {
      ...
      ItemProcessor: {
        ...
        ...this.props.iterator.toGraphJson(),
      },
      ItemReader: {
