...
export async function handler(event: LambdaEvent) {
  ...
  // The coordinate-copy-lambda function does not require special bucket construction as it just
  // uses the working bucket which is in the same account as the installation. So construct the
  // default here.
